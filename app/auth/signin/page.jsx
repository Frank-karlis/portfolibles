...
export default function Signin(){
    return(
        <main className="h-screen flex justify-center items-center py-16 px-8 bg-gradient-to-r from-slate-950 to-black">
            ...
            <div className="bg-green-50 p-4 flex flex-col justify-around ">
                <h1 className="text-xl"> Sign in to start managing your portfolio</h1>
